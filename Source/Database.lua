...
local Database = LibTSMDatabase:Init("Database")
local Schema = LibTSMDatabase:IncludeClassType("DatabaseSchema")
local Table = LibTSMDatabase:IncludeClassType("DatabaseTable")
