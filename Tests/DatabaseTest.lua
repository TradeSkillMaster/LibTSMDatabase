...
local LibTSMDatabase = TSM.LibTSMDatabase
local Database = LibTSMDatabase:Include("Database")
...
function TestDatabase:SetUp()
	...
	wipe(Locals["LibTSMDatabase.Database"].private.dbByNameLookup)
	LibTSMDatabase._moduleContext["Database"].moduleLoadFunc()
end
